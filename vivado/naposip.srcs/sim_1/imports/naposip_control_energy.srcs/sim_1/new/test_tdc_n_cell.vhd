...
entity test_tdc_n_cell is
    Generic (constant V : natural := 5);
end test_tdc_n_cell;

architecture Behavioral of test_tdc_n_cell is
...
constant nr_etaje : natural :=9;
signal start,stop,rst : STD_LOGIC;
signal outQ : STD_LOGIC_VECTOR (0 to nr_etaje);
signal en, energy: natural;

begin
test_tdc_n_cell: tdc_n_cell generic map (nr_etaje => nr_etaje) port map (start => start, stop => stop, R => rst, Q => outQ, energy_mon => en);
