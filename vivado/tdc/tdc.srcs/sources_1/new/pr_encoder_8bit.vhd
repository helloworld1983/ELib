...
inv1: delay_cell port map(a => I(2), y => net(1), consumption => en(1)); 
inv2: delay_cell port map(a => I(4), y => net(2), consumption => en(2)); 
inv3: delay_cell port map(a => I(5), y => net(3), consumption => en(3)); 
inv4: delay_cell port map(a => I(6), y => net(4), consumption => en(4)); 
